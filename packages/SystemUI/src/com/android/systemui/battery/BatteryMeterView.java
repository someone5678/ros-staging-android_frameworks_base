...
public class BatteryMeterView extends LinearLayout implements DarkReceiver {
    ...
    public void onBatteryLevelChanged(@IntRange(from = 0, to = 100) int level, boolean pluggedIn) {
        ...
        if (mPluggedIn != pluggedIn) {
            ...
            mRLandscapeDrawableStyleA.setCharging(mPluggedIn);
            mLandscapeDrawableStyleA.setCharging(mPluggedIn);
            mRLandscapeDrawableStyleB.setCharging(mPluggedIn);
            mLandscapeDrawableStyleB.setCharging(mPluggedIn);
            mLandscapeDrawableBuddy.setCharging(mPluggedIn);
            mLandscapeDrawableLine.setCharging(mPluggedIn);
            mLandscapeDrawableMusku.setCharging(mPluggedIn);
            mLandscapeDrawablePill.setCharging(mPluggedIn);
            mLandscapeDrawableSignal.setCharging(mPluggedIn);
            updateShowPercent();
            updatePercentText();
        }
    }
